    ...
    Courses: [
        {
            ...
            author: {
                ...
                designation: "Doctorado en Ahorro"
            }
        },
        {
            id: 2,
            ...
            author: {
                ...
                designation: "Master en Finanzas"
            }
        },
        {
            id: 3,
            ...
            `,
            published: "Abril 3,  2023",
            author: {
                name: "Juan Manuel Young Hoyos",
                img: "/images/author/4.jpg",
                designation: "Doctorado de Inversiones"
            }
        },
        {
            id: 4,
            ...
            published: "Jul 3,  2023",
            author: {
                name: "Alexander Gallo",
                img: "/images/author/3.jpg",
                designation: "Master en Finanzas"
            }
        },
    ],
    ...
    Posts: [
        {
            ...
            Si bien esto es relevante, conocimos en la entrada anterior que este está compuesto de diferentes elementos, pero hablaremos ahora de uno de los más importantes: la tasa. La tasa para los CDT nace en 1982, tras la crisis económica que atravesó América Latina, con la intención de permitir la colocación de préstamos que pudieran potenciar a las pequeñas y medianas empresas. Esto básicamente flexibilizó los parámetros para otorgar los CDT, posibilitando la reactivación económica en el momento, todo basándose en una tasa calculada por el Banco Central cada 90 días, de cara comprender el monto y la tasa promedio que se daba en los préstamos de corto plazo, es decir, para este entonces se “unifica” la tasa para los CDT como marco de referencia para las entidades financieras, ¡todo un hito! Esta se complejizó para 1998 a raíz de la coyuntura nacional y se ratificó bajo la Resolución 42.

            Con las reformas implementadas a inicios de los años noventa a nivel económico, político y social, se dio una gran independencia al Banco de la República, lo que a su vez posibilitó que herramientas para la captación de recursos como los CDT y las cuentas de ahorro se popularizaran (dadas las recomendaciones del Banco y las medidas tomadas por los gobiernos), aumentando así la competencia dentro del sistema financiero y generando aumentos en la tasa de interés real desde 1994. ¿Por qué esto es relevante? Porque al aumentar el número de competidores en el mercado se podían dar tarifas preferenciales y otro tipo de beneficios a los consumidores, al tiempo en que se volvía más atractivo el ahorro por el efecto de la tasa de interés en los CDT, por ejemplo.
            `,
            published: "Febrero 3,  2022",
            author: {
        ...
        },
        {
            ...
            E incluso puedes creer que más adelante va a llegar el momento perfecto, pero tú sabes que algo puede surgir: la vida sigue sucediendo, tenemos ocupaciones y más cosas.

            Si tú realmente quieres arreglar tu relajote financiero y encontrar oportunidades con tu dinero ¿te comprometerás a resolverlo incluso si no es el momento perfecto? Esa es tu mejor opción. Así que no lo pienses más.

            Aferrarte a esperar al momento perfecto es otra forma de miedo y ya sabes que puede ser muy persuasivo para detenerte, pero no te va ayudar a avanzar ni estar mejor.
            `,
            published: "Jun 5,  2023",
            author: {
                name: "Juan Manuel Young Hoyos",
